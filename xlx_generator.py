...
def save_to_excel(profiles, filename):
    ...
    headers = ["ID", "Nome", "Idade", "E-mail", "Senha", "Data de Nascimento", "Gênero", "Etnia", "Nome da Mãe",
    ...
    for profile in profiles:
        ws.append([profile["id"], profile["Nome"], profile["Idade"], profile["E-mail"], profile["Senha"], profile["Data de Nascimento"], profile["Gênero"], 
