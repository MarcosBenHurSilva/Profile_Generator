...
def generate_mother_by_name(full_name):
    ...
    shared_surnames = random.sample(
        set(full_name.split()[1:]), shared_num_mother_surnames
    )

    # Sobrenomes exclusivos da mãe
    mother_last_names = random.sample(
        set(unique_mother_surnames) - set(shared_surnames),
        num_mother_surnames - shared_num_mother_surnames,
    )
