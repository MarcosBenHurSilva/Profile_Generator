...
def generate_mother_by_name(full_name):
    ...
    # shared_surnames = random.sample(list(set(full_name.split()[1:])), shared_num_mother_surnames)
    
    # # Sobrenomes exclusivos da mãe
    # mother_last_names = random.sample(set(unique_mother_surnames) - set(shared_surnames), num_mother_surnames - shared_num_mother_surnames)
    
    # # Combinando o nome completo da mãe
    # full_mother_name = ' '.join(first_mother_name + mother_last_names + shared_surnames)
